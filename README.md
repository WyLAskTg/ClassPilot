...
ClassPilot 是一款支持多学期管理、灵活课程安排和本地数据存储的桌面课程表应用，支持中英双语。
...
你可以在 GitHub Releases 找到安装包。

![ClassPilot 中文界面截图](docs/classpilot-screenshot-zh.png)
...
You can find the installer on GitHub Releases.
